...
const DemoComponent = () => {
    ...
    const cards = [
        {
            id: 1,
            image: `?${encodeURIComponent('Mantenimientos ')}`,
        ...
        {
            id: 2,
            image: `?${encodeURIComponent('Repuestos')}`,
            title: 'NIKE JSA',
    ...
    return (
        <div data-swipe className="overflow-x-scroll scrollbar-hide relative px-0.5 mt-[0] p-[2rem] bg-white border-b mx-[4%] h-[auto] mb-[5rem]" style={{ overflowY: 'hidden' }}>
            <div className='mx-[1%]'>
