        ...
        <>
            <section className="py-24 bg-black">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-10 lg:mb-16 flex justify-center items-center flex-col gap-x-0 gap-y-6 lg:gap-y-0 lg:flex-row lg:justify-between max-md:max-w-lg max-md:mx-auto appear">
                        ...
                        <div className="relative w-full text-center lg:text-left lg:w-2/4">
                            ...
                            <a
                                href="#"
                                className="flex flex-row items-center justify-center gap-2 text-base font-semibold text-white lg:justify-start hover:text-indigo-700"
                            >
                                Button CTA
                                <svg
                                    width="20"
                    ...
                    <div className="flex justify-center items-center gap-x-5 gap-y-8 max-[1200px]:gap-y-[1rem] lg:gap-y-[1rem] flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
